...
1. **Interoperate by default:** We adopt shared interfaces and data formats so that tools compose rather than collide.
1. **Openness:** What we build for the shared foundation is open source, documented, and available to everyone.
1. **Room to innovate:** Alignment is not uniformity. We coordinate on foundations and leave every team free to experiment above them.
1. **Evidence over opinion:** We let developer feedback and ecosystem data decide what we work on first.
...
| Person | Organization |
|---|---|
| [Robertino Martinez](https://github.com/rober-m) | [Input Output Global](https://iog.io) |
